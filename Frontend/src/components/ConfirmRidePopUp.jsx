...
const ConfirmRidePopUp = ({ setRidingPopUpPanel, setConfirmRidingPopUpPanel }) => {
  ...
  return (
    <div>
      <h5
        onClick={() => {
          setConfirmRidingPopUpPanel(false);
        }}
      ...
      <div className="flex gap-2 justify-between flex-col items-center">
        ...
        <form className="w-full relative top-20" onSubmit={otpSubmitHandler}>
          <div className="flex flex-col px-4 py-4">
            <div>
              <input
                className="w-full px-4 py-2 text-center bg-gray-200 rounded-sm focus:outline-none focus:border-none"
                type="number"
            ...
            <div className="flex gap-2">
              <Link
                to="/captain-riding"
                className="w-1/2 flex justify-center mt-5 bg-green-600 text-white font-semibold p-2 rounded-sm"
              >
                Confirm
              </Link>
              <button
                ...
                className="w-1/2 mt-5 bg-red-500 text-black font-semibold p-2 rounded-sm"
              >
                Cancel
              </button>
            </div>
...
ConfirmRidePopUp.propTypes = propTypes;
